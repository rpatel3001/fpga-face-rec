...
from pynq.overlays.hlsresize import HlsResizeOverlay
import cProfile
...
base = HlsResizeOverlay("hlsresize.bit", XRES, YRES, procScale, download=True)
...
frame_buf = base.resizer_in #Array(ctypes.c_uint8, XRES*YRES*3)
